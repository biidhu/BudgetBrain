...
- Added user authentication (JWT login/register)
- Created dashboard with financial summary
-
...
- Built frontend UI pages
-

## How Tested (required)
<!-- "It works on my machine" is not a test. Write the commands or steps. -->
- [ ] Ran locally: (commands)
- [ ] Tests: (commands / results)
- [ ] CI checks: (link if helpful)
